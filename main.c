...
//                key = getch();
            ...
            if (err==LTR_OK)
            {
                ...
                hltr24.ChannelMode[0].Range = LTR24_RANGE_2;
                hltr24.ChannelMode[0].AC = TRUE;
                ...
                hltr24.ChannelMode[2].Enable = TRUE;
                hltr24.ChannelMode[2].Range = LTR24_RANGE_2;
                hltr24.ChannelMode[2].AC = TRUE;
                hltr24.ChannelMode[2].ICPMode = FALSE;

                hltr24.ChannelMode[3].Enable = TRUE;
                hltr24.ChannelMode[3].Range = LTR24_RANGE_2;
                hltr24.ChannelMode[3].AC = TRUE;
                hltr24.ChannelMode[3].ICPMode = FALSE;
                ...
                while (!f_out && (err==LTR_OK))
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            t1 = mtime();
                            for (cur_pos=0; cur_pos < LTR24_CHANNEL_NUM*RECV_BLOCK_CH_SIZE; cur_pos+=4)
                            {
